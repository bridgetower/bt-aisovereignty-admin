...
export const TwoFaSetting: React.FC<TwoFaSettingProps> = ({
  open,
  onClose,
  is2FaEnabled,
}) => {
  ...
  return (
    <Dialog open={open} onOpenChange={() => onClose()}>
      <DialogContent className="text-white bg-foreground">
          ...
          {!is2FaEnabled && (
            <div>
              <p className="font-normal text-sm">
                ...
                Authy), and select the option to scan a QR code. Point your
                camera at below QR. After scanning, the app will display a
                6-digit code. Enter that code below to finish the setup.
              </p>
              <div className="mt-6">
                <div className="flex justify-center bg-white w-fit mx-auto p-1">
