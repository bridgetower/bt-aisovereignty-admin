...
const transactionInitial = {
  blockHash:
    '0xd2703c71eb3ed46f4312398fcc1daac41638249d919da19f0387c40beaac89c7',
  ...
  gasLimit: '34914',
  metaData:
    '0x73e55949be12f43dd0b6ed38866c3563c11847c517a5c077a0d223f08d9cfbcc',
  nonce: '378',
  to: '0x7b72b77b930656591D0281DEC0532cA6a4a55AB4',
  transactionHash:
    '0x1640972dc53ddfe901f1edf9ce28797c2196e2e90add92e467d7bbf80c1626cb',
  type: '2',
};
...
const ProjectDetails: React.FC<Props> = (props) => {
  const [latestConfirmations, setLatestConfirmations] = React.useState<
    string | null
  >(null);
  const [transactionData, setTransactionData] =
    React.useState<typeof transactionInitial>(transactionInitial);
      ...
      {transactionData && (
        <>
          ...
          <div className="pt-5">
            ...
            <InlineDetails
              value={parseFloat(transactionData?.gas) + ' AVAX'}
              title="Gas used"
            />
          </div>
          ...
          <div className="flex justify-center pt-5">
            <a
              href={`https://testnet.snowtrace.io/tx/${transactionData.hash}`}
              target="_blank"
            ...
            >
              View on Snowtrace{' '}
              <img
                src="https://snowtrace.io/cdn/chains/avax/avax_32.avif"
                alt="logo"
                className="h-5 ml-1 mt-0.5"
              />
...
const InlineDetails = ({
  ...
  const [copiedText, onCopy] = useCopyToClipboard();
  return (
    <div className="py-3 shadow-sm rounded-md px-4 mt-2 bg-card text-primary">
      <div className="flex items-center">
        <h3 className="text-sm font-bold text-primary capitalize whitespace-nowrap">
          {title}:
        </h3>

        <p className="ml-2 text-primary text-sm  truncate col-span-3 tr">
          {value}
        </p>
        {showCopyIcon && (
